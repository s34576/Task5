public class Main {
    public static void main(String[] args) {
        // Przykład interakcji między obiektami i kopiowania przez
      //  referencję
...
// Dodaj wydarzenia i klientów
        ...
        Klient klient2 = new Klient("Anna", "Nowak",
                "anna@example.com");
        system.dodajKlient(klient1);
        system.dodajKlient(klient2);
...
// Modyfikacja wydarzenia przez referencję - wpłynie na
                //wszystkich klientów, którzy mają to wydarzenie
